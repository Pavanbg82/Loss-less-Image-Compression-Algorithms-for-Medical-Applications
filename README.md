...
## Project Overview
This project implements lossless image compression algorithms for medical applications. It includes algorithm-level implementation and hardware realization, followed by verification to ensure exact image reconstruction without any data loss.
...
1. Run MATLAB scripts for pixel extraction ,comparitive analysis ,reconstruction of image,& for verification.
2. Simulate Huffman Coding & combined RLE and DPCM compression Technique Verilog files using Vivado or ModelSim.
